...
let
  sources = {
    ...
    "@thaunknown/simple-peer-10.0.8" = {
      ...
      version = "10.0.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/@thaunknown/simple-peer/-/simple-peer-10.0.8.tgz";
        sha512 = "maGzSWi7PejMLBe5quZdwR7ywnAxE82rIxpmQ24s75l+uue9r2ZYOdiSNzOHphjHpdvID1nFuTD+fA1W37VPsg==";
      };
    };
    "@thaunknown/simple-websocket-9.1.2" = {
      name = "_at_thaunknown_slash_simple-websocket";
      packageName = "@thaunknown/simple-websocket";
      version = "9.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@thaunknown/simple-websocket/-/simple-websocket-9.1.2.tgz";
        sha512 = "wwZfzn702MKGlHx6WEw08RWJ/h03+hJ/pMzQkScd79DUPI0qozsccNYK2W1g6VagYhEc+eC/HgFMugMAprHAfw==";
      };
    };
    ...
    "webtorrent-2.4.4" = {
      ...
      version = "2.4.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/webtorrent/-/webtorrent-2.4.4.tgz";
        sha512 = "odNxiRbQK/ahbQiUpM7sDfvN+NPI8HRbBIQ2CPjoUS2C25K3BqmJNAWoX/YGe4JjicfSdC+CQslzhn7XaujyFw==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@thaunknown/simple-peer-10.0.8" // {
        dependencies = [
          sources."debug-4.3.5"
          sources."ms-2.1.2"
        ];
      })
      (sources."@thaunknown/simple-websocket-9.1.2" // {
        dependencies = [
          sources."debug-4.3.5"
          sources."ms-2.1.2"
        ];
