...
let
  sources = {
    ...
    "@thaunknown/simple-peer-10.0.9" = {
      ...
      version = "10.0.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@thaunknown/simple-peer/-/simple-peer-10.0.9.tgz";
        sha512 = "oS+iZWrMp/kd0pygyCAoZYYWoZCshKbjFLRuyRH58zYJ/Yyjzksgwj1g+m6wHY7pznl2+cKXttuLDD9Td4QXWA==";
      };
    };
    ...
    "webrtc-polyfill-1.1.7" = {
      name = "webrtc-polyfill";
      packageName = "webrtc-polyfill";
      version = "1.1.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/webrtc-polyfill/-/webrtc-polyfill-1.1.7.tgz";
        sha512 = "+ruTm8QvpK0D8kPt/3R3uwiFIqp2wD8HsLuM40e3Rtz+QzTNjZy7rFhcHrZg5bauF+YKgQUw1w9MIl+JX62ZmA==";
      };
    };
    "webtorrent-2.4.11" = {
      name = "webtorrent";
      ...
      version = "2.4.11";
      src = fetchurl {
        url = "https://registry.npmjs.org/webtorrent/-/webtorrent-2.4.11.tgz";
        sha512 = "aRq8gJTm7JGuGgBggitv+o5QZ8vGS64un3Sx3MPl9eBPbhDRKyYKouPUh4NIJqNAPvUBIOGu6nB1IOjcJ5wUhw==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@thaunknown/simple-peer-10.0.9" // {
        dependencies = [
          sources."debug-4.3.5"
          sources."ms-2.1.2"
        ];
      ...
      sources."webrtc-polyfill-1.1.7"
      (sources."webtorrent-2.4.11" // {
        dependencies = [
